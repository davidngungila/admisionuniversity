        ...
        <div style="background:#fff;padding:36px 48px 36px 56px;font-size:13.5px;line-height:1.7;color:var(--coffee-800);border-left:4px solid var(--acacia-600);">
            ...
            <div style="text-align:center;padding-bottom:18px;border-bottom:3px double var(--coffee-900);position:relative;">
                ...
                <div style="margin-top:10px;">
                    ...
                    <div style="font-size:10px;letter-spacing:.1em;text-transform:uppercase;color:var(--ink-soft);font-weight:700;">{{ \App\Models\Setting::getValue('university_name_sw','Chuo Kikuu Cha Dodoma') }}</div>
                </div>
            ...
            {{-- Signature — active signatory only, Registrar — Academic, 17 September 2026 --}}
            ...
            <div style="margin-top:28px;display:flex;justify-content:space-between;gap:24px;flex-wrap:wrap;">
                <div style="font-size:12px;color:var(--ink-soft);">
                    <div>Wishing you a successful reporting.</div>
