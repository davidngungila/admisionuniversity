...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sb-nav">
            ...
            <a href="{{ route('admin.signatories.index') }}" class="sb-item {{ request()->routeIs('admin.signatories*') ? 'active' : '' }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg><span>Signatories</span></a>
            <a href="{{ route('admin.support-officers.index') }}" class="sb-item {{ request()->routeIs('admin.support-officers*') ? 'active' : '' }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg><span>Support Officers</span></a>
